...
$chart ="<chart palette='2' bgColor='FFFFFF' showBorder='0' caption='Product Comparison' shownames='1' showvalues='1'   showSum='1' decimals='0' useRoundEdges='1'>";
...
public function get_leadtime_chart_ajax(){
	...
	public function get_district_facility_($graph_type,$facility_code){
		
		switch ($graph_type) {
			case 'bar2d':
				 $this->get_stock_status_ajax($option="ajax-request",$facility_code);
				break;
