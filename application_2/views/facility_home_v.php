...
<div id="main_content">
	<div id="left_content">
	   ...
	   //  $stock=1;
		...
		<a href="<?php echo site_url('Issues_main/Index/Internal/'.$facility);?>"><h2>Issue Commodities</h2></a>
		</div>
		...
		<?php endif; ?>
			    <div class="activity update">
	    <a href="<?php echo site_url('order_management/stock_level/v');?>"><h2>Update Physical Stock</h2>	</a>
		</div>
