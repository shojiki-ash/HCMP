...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <section id="registersec">
    	...
    	<input type="text" class="validate[required]" name="fname" placeholder="First Name" />
    	<label>Other Name</label>
    	<input type="text" class="validate[required]" name="lname" placeholder="Other Name"  />
    	<label>Email</label>
    	<input type="email" class="validate[required,custom[email]]" placeholder="Johndoe@domain.com" name="email"/>
    	<label>Phone Number</label>
    	<input type="text" name="telephone" name="telephone" class="validate[custom[phone]]" placeholder="254xxxxxxxxx" />
    	
    	<label>User Type</label>
    	<select name="type" class="registerdropDown">
		...
		<select id="counties" class="registerdropDown">
